...
class ColorMapWindow(AddonDialog):
    ...
    def __init__(self, parent, color_map, title='Customize color swapping', on_update=None):
    ...
    def init_ui(self, title):
        ...
        btn_add_mapping = create_button('+ Add color mapping', self.on_add)
        ...
        header = QLabel(_(
            ...
            'should be swapped when the redesign is on.'
        ))
